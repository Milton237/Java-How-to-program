 ...
 * @author MILTON PRO
 */
public class Exercise_8_2_Class {
    ...
    public Exercise_8_2_Class(){
        this(0, 0, 0);  // invoke Time2 constructor with three arguments
    }
    // Time2 constructor: hour supplied, minute and second defaulted to 0
    public Exercise_8_2_Class(int h){
        this(h, 0, 0);
    }
    // Time2 constructor: hour and minute supplied, second defaulted to 0
    public Exercise_8_2_Class(int h, int m){
        this(h, m, 0);
    }
    // Time2 constructor: hour, minute and second supplied
    public Exercise_8_2_Class(int h, int m, int s){
        setTime(h, m, s);
    }
    // Time2 constructor: another Time2 object supplied
    public Exercise_8_2_Class(Exercise_8_2_Class time){
